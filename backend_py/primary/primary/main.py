...
from primary.routers.stratigraphy.router import router as stratigraphy_router
...
app.include_router(stratigraphy_router, prefix="/stratigraphy", tags=["stratigraphy"])
