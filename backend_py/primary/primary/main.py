...
from primary.routers.well_flow_data.router import router as well_flow_data_router
...
logging.getLogger("primary.services.well_flow_data_assembler").setLevel(logging.DEBUG)
...
app.include_router(well_flow_data_router, prefix="/well_flow_data", tags=["well_flow_data"])
