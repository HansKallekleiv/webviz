...
class WellAccess:
    ...
    def get_wellbore_picks(self, field_identifier: str, pick_identifier) -> List[WellBorePick]:
        return []
    ...
    def get_wellbore_trajectory(self, wellbore_uuid: str = None) -> WellBoreTrajectory:
